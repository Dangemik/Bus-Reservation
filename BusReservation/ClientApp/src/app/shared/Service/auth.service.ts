...
export class AuthService {
  ...
  userData = new BehaviorSubject<UserAuthentication>(new UserAuthentication());    
  ...
  setUserDetails() {    
    if (localStorage.getItem('authToken')) {    
      const userDetails = new UserAuthentication();    
  ...
  logout() {    
    ...
    this.userData.next(new UserAuthentication());    
  }
}
